...
server.get('/characters', async (req, res) => {
    const { id, name, gender, born, died, species, height, weight, hair_color, eye_color, skin_color, blood_status, marital_status, nationality, animagus, boggart, house, patronus, alias_names, jobs, family_members, romances, wands, image, wiki, titles, sort = 'name', order = 'asc', page, size, } = req.query;
...
server.get('/books', async (req, res) => {
    const { id, title, summary, author, release_date, dedication, pages, cover, wiki, chapters, sort = 'title', order = 'asc', page, size, } = req.query;
...
server.get('/movies', async (req, res) => {
    const { id, title, summary, directors, screenwriters, producers, cinematographers, editors, distributors, music_composers, release_date, running_time, budget, box_office, rating, trailer, poster, wiki, sort = 'title', order = 'asc', page, size, } = req.query;
...
server.get('/potions', async (req, res) => {
    const { id, name, effect, side_effects, characteristics, time, difficulty, ingredients, inventors, manufacturers, image, wiki, sort = 'title', order = 'asc', page, size, } = req.query;
...
server.get('/spells', {
    ...
    const { id, slug, name, incantation, category, effect, light, hand, creator, image, wiki, sort = 'title', order = 'asc', page, size, } = req.query;
